...
#'   autocorrelation.
#'   
#'   \code{\link{series_uncor}}: To extract a subset of uncorrelated series 
...
#'   
#'   \code{\link{N.plot}}: Shows the number of records.
#'    
...
#'   to load these data sets into R using the \code{data} function. The 
